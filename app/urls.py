...
urlpatterns = [
    ...
    path('curso/<slug:slug>/contenido/', course_content_view, name='course_content'),   # <--- contenido
    path('curso/<slug:slug>/', CourseShowView.as_view(), name='course_detail'),        # <--- público
